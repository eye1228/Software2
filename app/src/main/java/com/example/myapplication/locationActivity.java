...
//textview_address 주소 설정
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Button ShowLocationButton = (Button) findViewById(R.id.button); //버튼클릭 이벤트
        ShowLocationButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View arg0)
            {
                ...
                Toast.makeText(locationActivity.this, address + longitude, Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        builder.setPositiveButton("설정", new DialogInterface.OnClickListener() { //버튼
            @Override
